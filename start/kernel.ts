...
server.use([
  ...
  () => import('#middleware/websocket_middleware'), // WebSocket middleware en premier pour intercepter les upgrades
...
export const middleware = router.named({
  ...
  adminRoleGuard: () => import('#middleware/admin_role_guard_middleware')
})
